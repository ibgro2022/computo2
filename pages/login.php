              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Sistema de Inventario <br/> IBGro 2022</h1>
                  </div>
                  <form class="user" role="form" action="processlogin.php" method="post">
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        ...
                        <label class="custom-control-label" for="customCheck">Recordar Información</label>
                      </div>
                    </div>
